...
* [The empty struct](https://dave.cheney.net/2014/03/25/the-empty-struct)  `struct{}` 不占空间, 在Channel中可以用于发送信号

* [Go语言小技巧--一 技巧杂烩](http://zablog.me/2017/09/04/go_tricks_and_tips/) 一些小技巧

### nil

  * [不得不知道的golang知识点之nil](https://gocn.io/article/478) 侧重nil的比较
