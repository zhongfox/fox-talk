...
<img width="80%" src="https://istio.io/docs/examples/bookinfo/noistio.svg">
...
* template_variety: 可选Check, Report, Quota or AttributeGenerator, 决定了adapter必须实现的方法. 同时决定了在mixer的什么阶段要生成template对应的instance:
  ...
  * AttributeGenerator: for both Check, Report Mixer API calls, TODO
...
就我个人的经历来说, 我之前从事过较多的服务治理相关的工作, 过程中切身体会到微服务治理的痛点, 所以也比较关注 service mesh的发展, 个人对istio也非常看好, 刚好今年我们中心容器产品今年也有这方面的计划, 期待我们能在这个方向进行一些产品和技术的深耕.
