...
header-img: //zhongfox-blogimage-1256048497.cos.ap-guangzhou.myqcloud.com/2021-04-07-134535.png
...
我想应该有不少程序员都做过这样的「美梦」: 我不想了解依赖系统各种复杂的差异，我只想面向接口编程。 如今 dapr 把这种理想化的架构模式给初步的实现了，这也是为什么 dapr 目前虽然还不是很成熟，就已经吸引了大量开发者的关注。接下来虽然社区的积极投入，dapr 的生态会更加完善。
