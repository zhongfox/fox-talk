...
* 命令区分ref 还是 path
  ...
  <https://stackoverflow.com/questions/26349191/fatal-ambiguous-argument-branch-name-both-revision-and-filename>

  * ref: `git checkout some_ref --`
  * path: `git checkout -- some_path`
