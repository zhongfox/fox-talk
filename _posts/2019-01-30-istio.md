...
header-img: assets/images/istio/istio_boats_1.png

---

<img src="/assets/images/istio/title.png">
...
<img src="/assets/images/istio/1.1.png">
...
<img src="/assets/images/istio/1.2.png">
...
<img src="/assets/images/istio/1.3.png">
...
<img src="/assets/images/istio/1.4.png">
...
<img src="/assets/images/istio/1.6.png">
...
<img src="/assets/images/istio/1.7.png">
...
另外, istio 对 数据面注入的内容存于名为`istio-sidecar-injector` 的configmap, 高级用户可以按需修改这个模板内容:
...
* `0.0.0.0:port` 作为listener
* hosts, addresses 作为virtualhost
* endpoints 作为 cds 对应的eds

对于tcp类型port:

* addresses+ports 作为listener
* endpoints 作为 cds 对应的eds
...
如果没有指定endpoints, 在请求处理过程中, 会请求dns解析ip地址作为endpoint

如果设置了endpoints, endpoints将作为dns解析结果

```
{
version_info: "2019-07-12T09:00:27Z/13",
cluster: {
...
last_updated: "2019-07-12T09:00:27.946Z"
},
```
...
```
{
version_info: "2019-07-12T09:19:37Z/15",
cluster: {
name: "outbound|8000||httpbin.bar.global",
type: "EDS",
eds_cluster_config: {
...
service_name: "outbound|8000||httpbin.bar.global"
},
connect_timeout: "10s",
circuit_breakers: {
thresholds: [
...
last_updated: "2019-07-12T09:19:37.772Z"
},
```
...
<img src="/assets/images/istio/gateway.png">
...
<img src="/assets/images/istio/last.png">
