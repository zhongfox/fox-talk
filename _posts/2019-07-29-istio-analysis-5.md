...
1. 创建VirtualService `meshexpansion-vs-pilot`, 将主集群Pilot通过gateway暴露给子集群使用.
2. 创建VirtualService `meshexpansion-vs-citadel`, 将主集群Citadel通过gateway暴露给子集群使用.
